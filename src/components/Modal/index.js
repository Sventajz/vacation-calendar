      ...
      <LoginModal>
        <ModalWindow>
          <Wrapper>
            {isDeclineRequest ? (
              <FormLogin>
                <h3>Are you sure you want to decline the request?</h3>
                <BtnLogin onClick={onClick}>Decline PTO</BtnLogin>
              </FormLogin>
            ) : (
              <FormLogin
                onSubmit={isLogin ? handleLoginSubmit : handlePtoSubmit}
              >
                <Credentials>
